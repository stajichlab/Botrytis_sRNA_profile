...
ggsave("All_Libraries_size_profile_uniq.pdf",pg,height=18,width=12)
...
pie
ggsave("All_Libraries_Piechart_uniq.pdf",pie)
...
pg <- plot_grid(pN, pE, pO, labels = c('A', 'B', "C"), label_size = 12,ncol = 1,align = "v")
ggsave("Mycelium_size_profile_uniq.pdf",pg,height=18,width=12)
...
pie
ggsave("Mycelium_Piechart_uniq.pdf",pie,height=8,width=8)
...
pg <- plot_grid(pN, pE, pO, labels = c('A', 'B', "C"), label_size = 12,ncol = 1,align = "v")
ggsave("TomatoInfection_size_profile_uniq.pdf",pg,height=18,width=12)
...
pie
ggsave("TomatoInfection_Piechart_uniq.pdf",pie,width=8,height=8)
...
pg <- plot_grid(pN, pE, pO, labels = c('A', 'B', "C"), label_size = 12,ncol = 1,align = "v")
ggsave("MockInfection_size_profile_uniq.pdf",pg,height=18,width=12)
...
pie
ggsave("MockInfection_Piechart_uniq.pdf",pie,width=8,height=8)
